...
from motiondiff_modules.mGPT.utils.joints import smplh_to_mmm_scaling_factor
from motiondiff_modules.mGPT.utils.joints import smplh2mmm_indexes
...
def smplh_to(jointstype, data, trans):
    from motiondiff_modules.mGPT.utils.joints import get_root_idx
    ...
    if "mmm" in jointstype:
        ...
        from motiondiff_modules.mGPT.utils.joints import smplh2smplnh_indexes
